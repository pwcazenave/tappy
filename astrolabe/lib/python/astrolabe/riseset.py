...
from astrolabe.calendar import sidereal_time_greenwich
from astrolabe.constants import seconds_per_day, pi2, earth_equ_radius, standard_rst_altitude
from astrolabe.dynamical import deltaT_seconds
from astrolabe.util import d_to_r, interpolate_angle3, diff_angle, r_to_d, modpi2, interpolate3, equ_to_horiz
...
def rise(jd, raList, decList, h0, delta):
    ...
    """
    longitude = astrolabe.globals.longitude
    latitude = astrolabe.globals.latitude
