...
from astrolabe.nutation import nut_in_lon
from astrolabe.sun import aberration_low, Sun
from astrolabe.util import d_to_r, polynomial, modpi2, diff_angle
from astrolabe.vsop87d import vsop_to_fk5
...
def equinox_approx(yr, season):
    ...
    if season not in astrolabe.globals.season_names:
