...
"""
from math import *
from astrolabe.util import d_to_r, modpi2, fday_to_hms, hms_to_fday
...
def is_dst(jd):
    ...
    """
    if not astrolabe.globals.daylight_timezone_name:
        return False
...
def lt_to_str(jd, zone = "", level = "second"):
    ...
    month = astrolabe.globals.month_names[mon-1]
    ...
    if level == "day":    
        return "%d-%s-%02d" % (yr, astrolabe.globals.month_names[mon-1], iday)
